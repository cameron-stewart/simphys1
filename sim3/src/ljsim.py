...
ylabel("Energy E")
#legend()
savefig('../dat/Energies{}{}.png'.format(tstat,warm),bbox_inches='tight')
close()
# Total Energy
plot(ts, Es[:,2],'b-',label=r'E_{tot}')
xlabel("Time t")
ylabel("Energy E")
#legend()
savefig('../dat/Total_Energy{}{}.png'.format(tstat,warm),bbox_inches='tight')
close()
# Temperature
...
#legend()
savefig('../dat/Temperature{}{}.png'.format(tstat,warm),bbox_inches='tight')
close()
# Pressure
...
ylabel("Pressure P")
#legend()
savefig('../dat/Pressure{}{}.png'.format(tstat,warm),bbox_inches='tight')
close()
